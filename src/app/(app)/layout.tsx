          ...
          <Dialog open={isZapConnectOpen} onOpenChange={setZapConnectOpen}>
            <SidebarMenu>
              ...
              {permissions.automations && (
                <SidebarMenuItem>
                    <SidebarMenuButton asChild isActive={pathname.startsWith('/automations')} tooltip={{ children: 'Automações' }}>
                        <Link href="/automations/due-date"><Bot /><span>Automações</span></Link>
                    </SidebarMenuButton>
                </SidebarMenuItem>
              )}
