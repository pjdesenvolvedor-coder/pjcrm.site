...
export default function ShotListPage() {
  ...
  return (
    <div className="flex flex-col h-full">
      <PageHeader
        title="Disparo por Lista"
        description="Envie mensagens colando uma lista de números do WhatsApp."
      />
      <main className="flex-1 overflow-auto p-4 md:p-6">
        <div className="w-full max-w-3xl mx-auto">
            <Card className="shadow-lg">
              <CardHeader>
                <CardTitle className="text-2xl">Criar Disparo por Lista</CardTitle>
                <CardDescription>
