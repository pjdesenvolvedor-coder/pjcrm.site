  ...
  const grantPlanAccess = useCallback(async (plan: 'basic' | 'pro', isTrial = false) => {
    ...
    try {
      ...
      const allPermissionsFalse: UserPermissions = {
        ...
        attendants: false, notes: false, ads: false, pix: false, usage: false, logs: false, dbCleaner: false, zapVendas: false, calendario: false
      };
      ...
      if (plan === 'basic') {
        ...
        newPermissions = { ...allPermissionsFalse, dashboard: true, customers: true, inbox: true, automations: true, groups: true, shot: true, zapconnect: true, settings: true, estoque: true };
      }
